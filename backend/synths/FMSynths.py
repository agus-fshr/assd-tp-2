...
class FMSynth(SynthBaseClass):
    ...
    def __init__(self):
        ...
        self.params = ParameterList(
            ...
            NumParam("N1", interval=(0, 10), value=3, step=0.1, text="Carrier multiplier"),
            NumParam("N2", interval=(0, 10), value=2, step=0.1, text="Modulator multiplier"),
            ...
            NumParam("s1", interval=(0, 1), value=0.85, step=0.1, text="Sustain final value, modulator "), #[0,1] as a fraction of the sustain value that will be dropped
            ...
            NumParam("fmConst", interval=(-10, 10), value=0.5, step=0.01, text="Modulation frequency addition"),
